...
Учусь в аспирантуре в ВГУ, там же преподаю, работаю в Сбере. В свободное время разрабатываю всякие [программные продукты](https://github.com/ekertn7/ConnectionZ), читаю умные [книги](/additional/BOOKS.md), смотрю кино, путешествую и активно отдыхаю.

Ищу компанию, в которой я смогу использовать свои знания и навыки, чтобы создавать отличные программные продукты и делать этот мир немного лучше.

# Софты

- Быстро учусь, беру и выполняю сложные задачи, внимательно отношусь к деталям
- Умею организовывать работу в команде, обладаю навыками эффективных коммуникаций
- Критически мыслю, стремлюсь к саморазвитию и готов брать на себя инициативу
- Знаю русский и английский языки, пишу без ош~~ы~~бок

# Харды

Использую часто: `FastAPI` `Pydantic` `SQLAlchemy` `Alembic` `PostgreSQL` `ReactJS` `SASS` `LESS` `GIT` `Linux`

Использую реже: `RabbitMQ` `PyTorch` `LangChain` `Pandas` `Numpy` `Requests` `Selenium` `Hadoop` `MS SQL` `Docker`
...
[![gm-ai-1](/images/gm-ai-1-mini.png)](/images/gm-ai-1.png) 
[![gm-ai-2](/images/gm-ai-2-mini.png)](/images/gm-ai-2.png) 
[![gm-ai-3](/images/gm-ai-3-mini.png)](/images/gm-ai-3.png)  
